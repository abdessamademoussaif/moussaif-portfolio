...
const ProjectsSection = () => {
  return (
    <section id="projects" className="!min-h-fit w-full max-w-screen">
          ...
          <AnimatedWrapper key={project.id} from="right" delay={0.1 * idx}>
            <div className="flex flex-wrap flex-col-reverse lg:flex-row items-center justify-center gap-8">
              <div className="flex-1 flex flex-col gap-4">
                ...
                <div className="flex gap-2 max-[420px]:justify-around items-center max-[399px]:flex-col">
              ...
              <Image
                ...
                width={400}
                height={400}
                className="w-auto h-auto rounded-2xl  border border-black"
              />
            </div>
          </AnimatedWrapper>
        ))}
      </div>
      <div className="flex items-start justify-center mt-10 lg:mt-16">
        <Link href="https://github.com/abdessamademoussaif" target="_blank">
