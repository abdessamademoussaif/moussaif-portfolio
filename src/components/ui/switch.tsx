  ...
  return (
    <SwitchPrimitive.Root
      ...
      <SwitchPrimitive.Thumb
        ...
        className={cn(
          'bg-primary pointer-events-none block size-5 rounded-full shadow-xs ring-0 transition-transform data-[state=checked]:translate-x-4 data-[state=unchecked]:translate-x-0 data-[state=checked]:rtl:-translate-x-4'
        )}
      />
    </SwitchPrimitive.Root>
  );
