  ...
  return (
    <AccordionPrimitive.Header className="flex">
      <AccordionPrimitive.Trigger
        ...
        <ChevronDownIcon
          size={16}
          className="pointer-events-none shrink-0 opacity-60 transition-transform duration-300"
          aria-hidden="true"
        />
      </AccordionPrimitive.Trigger>
...
function AccordionContent({
  ...
  return (
    <AccordionPrimitive.Content
      ...
      className="data-[state=closed]:animate-accordion-up animation-duration-[300ms] data-[state=open]:animate-accordion-down overflow-hidden text-sm"
      {...props}>
